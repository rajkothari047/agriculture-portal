...
<title>Admin Login - KisanMitra Secure Panel</title>
...
<div class="main-content">
    <div class="welcome-panel">
        <div class="text-center max-w-lg px-4 relative">
            ...
            <p class="text-lg mb-8 text-white/90">You can sign in to access your secure admin panel and manage the KisanMitra platform.</p>
            <p class="mt-12 text-sm text-white/70">"Cultivating trust and prosperity through technology."</p>
        </div>
    </div>
    ...
    <div class="login-form-panel">
        ...
        <div class="w-full max-w-sm mx-auto mt-16">
            <h2 class="text-3xl font-extrabold text-gray-800 mb-2">Admin Sign In</h2>
            <p class="text-gray-500 mb-8">Enter your credentials below.</p>
            ...
            <form method="POST" action="">
                <div class="mb-5">
                    ...
                    <div class="input-group-icon">
                        <i data-lucide="user" class="lucide w-5 h-5"></i>
                        <input type="text" class="form-input-field" id="adminId" name="admin_name" placeholder="Your Admin Username" required>
                    </div>
                </div>
                ...
                <div class="mb-5">
                    ...
                    <div class="input-group-icon">
                        ...
                        <input type="password" class="form-input-field" id="password" name="admin_password" placeholder="••••••••" required>
                ...
                <div class="flex items-center justify-between mb-8">
                    ...
                    <div class="text-sm">
                        <a href="#" class="font-medium text-primary hover:text-accent transition-colors">Forgot password?</a>
                    </div>
                </div>

                <button type="submit" name="adminlogin" class="btn-primary-action mb-4">
