...
<head>
    ...
    <title>Secure Verification | KisanMitra</title>
    ...
    <style>
        ...
        * {
        ...
        /* Animated Farmer Scene Background */
        .farm-scene {
            position: fixed;
            bottom: 0;
            left: 0;
        ...
        /* Floating Farmers / Tractor Icons */
        .floating-icon {
            position: absolute;
            opacity: 0.15;
            pointer-events: none;
        ...
        .btn-verify {
            ...
            position: relative;
            overflow: hidden;
            box-shadow: 0 8px 20px -5px rgba(10, 61, 10, 0.3);
        }
        ...
        .btn-verify:hover {
            transform: translateY(-3px);
            box-shadow: 0 15px 30px -8px rgba(10, 61, 10, 0.4);
        }
...
<div class="verification-container">
    <div class="verification-card">
        ...
        <div class="verification-header">
            ...
            <p>Enter the 5-digit code sent to your registered email address to complete your login</p>
            <div class="farmer-greeting">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/>
                    <circle cx="12" cy="7" r="4"/>
                </svg>
                <span>Farmer Account Verification</span>
            </div>
        </div>
        ...
        <form onsubmit="return false;">
            <input type="hidden" id="otp" name="farmer_otp" value="">
