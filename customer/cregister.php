...
<title>Customer Registration - KisanMitra Portal</title>
...
.form-control:focus {
    ...
    box-shadow: 0 0 10px rgba(78, 159, 61, 0.3);
    color: white;
}
.input-group-text {
...
.navbar-scrolled .nav-center-btn { 
    color:white !important; 
}
...
/* Footer */
footer { background-color: var(--color-primary-dark); color:white; padding-top:4rem; padding-bottom:2rem; }
footer a { color: #f1f5f9; transition: color 0.2s; }
...
@media (max-width: 992px) {
    ...
    .register-card-new { max-width: 100%; }
}
</style>
</head>
    ...
    <div class="flex items-center space-x-4 desktop-nav-links">
        ...
        <div class="relative dropdown">
            ...
            <div class="dropdown-content">
                <a href="../farmer/fregister.php"><i data-lucide="tractor"></i> Farmer Account</a>
            </div>
        </div>
    ...
    <div class="popup-container">
        ...
        <div class="popup-content">
            ...
            <p class="popup-message">
                ...
                Please use a different email address or <a href="../customer/clogin.php" style="color: #B85C38; font-weight: bold;">login to your existing account</a>.
            </p>
...
<div class="page-container">
    <div class="info-panel">
        ...
        <h1 class="info-heading" style="color: var(--color-accent-terracotta) !important;">Start Growing!</h1>
        <p class="info-text">We source the healthiest and most beautiful plants to bring nature's finest to your home. Join our happy community today!</p>
        ...
        <div class="login-link-box">
            <p class="mb-0 text-dark">Already have an account? <a href="../customer/clogin.php" class="text-success font-weight-bold">Log In here</a></p>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-control" id="district-list" name="city" required>
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control" id="pincode" name="pincode" placeholder="Pincode" min="100000" max="999999" required/>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        <div class="input-group">
                            ...
                            <span toggle="#password" class="toggle-password"><i class="fas fa-eye" id="eye-icon"></i></span>
                        </div>
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <div class="input-group">
                            ...
                            <span toggle="#confirmpassword" class="toggle-password"><i class="fas fa-eye" id="eye-icon-confirm"></i></span>
                        </div>
                    </div>
                </div>

                <div class="form-group mt-3">
                    <button type="submit" class="btn btn-register-new" name="register">Register</button>
                </div>
            </form>
        </div>
    </div>
...
<?php if(isset($error) && (strpos($error, 'email already exists') !== false || strpos($error, 'This email already exists') !== false)): ?>
    // Show popup when page loads if email error exists
    setTimeout(function() {
        showEmailPopup();
    }, 100);
<?php endif; ?>
...
$(window).scroll(function() {
    if($(window).scrollTop() > 50){
        $("#main-header").addClass("navbar-scrolled");
    } else {
        $("#main-header").removeClass("navbar-scrolled");
    }
});
