...
<title>Customer Login - KisanMitra Portal</title>
...
<div class="main-content">
    <div class="welcome-panel">
        <div class="text-center max-w-lg px-4 relative">
            ...
            <p class="text-lg mb-8 text-white/90">Sign in to your customer account and explore KisanMitra services.</p>
    ...
    <div class="login-form-panel">
        ...
        <div class="w-full max-w-sm mx-auto mt-16">
            <h2 class="text-3xl font-extrabold text-gray-800 mb-2">Customer Sign In</h2>
            ...
            <form method="POST" action="">
                <div class="mb-5">
                    ...
                    <div class="input-group-icon">
                        ...
                        <input type="email" class="form-input-field" id="customerEmail" name="customer_email" placeholder="Your Email" required>
                    </div>
                </div>
                ...
                <div class="mb-5">
                    ...
                    <div class="input-group-icon">
                        ...
                        <input type="password" class="form-input-field" id="password" name="customer_password" placeholder="••••••••" required>
                ...
                <button type="submit" name="customerlogin" class="btn-primary-action mb-4">
